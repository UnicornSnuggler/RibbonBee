...
module.exports = {
    ...
    async execute(interaction) {        
        try {
            ...
            if (!commandOption) {
                embed.setThumbnail(MASCOT_SPRITE);
